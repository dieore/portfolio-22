...
const JobComponent = ({ app }) => {
    ...
    return (
        <div className="grid grid-cols-1 text-white md:h-80 sm:place-content-between text-justify font-light">
            <p>{app.text}</p>
            <button className="underline text-left hover:font-semibold md:mt-6" onClick={() => setDemo(true)}>Watch demo</button>
            ...
            {
                app.message && <p className="text-sm mt-6">{app.message}</p>
            }
            <Modal
                open={demo}
