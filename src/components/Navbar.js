...
const onScrollDown = "p-3 sticky top-0 bg-blue bg-opacity-90 z-10";
const onScrollTop = "p-3 sticky top-0 z-10";
...
const Navbar = () => {
    ...
    return (
        <>
            ...
            >
                <img className="fade-in lg:px-40 p-8" src="/img/cv.png" />
            </Modal>
        </>
    )
};
