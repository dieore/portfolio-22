...
const Job = ({ app }) => {
    ...
    return (
        <div className="grid grid-cols-1 text-white md:h-80 sm:place-content-between text-justify font-light md:text-base text-sm">
            ...
            <button className="underline text-left outline-none hover:font-semibold md:mt-3 mt-6" onClick={() => setDemo(true)}>Watch demo</button>
            ...
            {
                app.message && <p className="text-sm md:text-left mt-6 text-center">{app.message}</p>
            }
            <Modal
                open={demo}
